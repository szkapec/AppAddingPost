    ...
    return (
        <section className="form-container">
            <form autoComplete="off" noValidate onSubmit={handleSubmit} className="form">
                ...
                <div>
                    <input className="message" name="message" placeholder="Wiadomość" variant="outlined" label="Message" value={postData.message} onChange={(e) => setPostData({ ...postData, message: e.target.value})}/>
                </div>
                {/* <div>
